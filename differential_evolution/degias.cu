...
int main(int argc, char **argv)
{
    ...
    for (int i = 0; i < runs; i++)
    {
        ...
        int evals = 0;
        int m = 0;
        size_t shared_bytes = island_popsize * NUM_STRATEGIES * sizeof(float);
    ...
    log_data(function_number, dim, island_popsize, islands, "degias_16", best_log, time_log, eval_log); 
